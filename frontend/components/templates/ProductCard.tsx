    ...
    >
      {data &&
        data?.map((item: any, index: any) => {
          return (
            <div key={index} className="flex relative   w-full flex-col bg-gray-50 shadow-md  rounded-md hover:bg-slate-100 ">
              <Link
              ...
              <div
                dir="rtl"
                className="flex justify-end flex-col px-2 pb-3 pt-1 gap-1"
              >
          ...
          /> */}
              ...
              <div className="absolute bg-white/50 p-1 rounded-md top-3 right-3 pr-1">
                {" "}
                <div className="flex flex-row gap-2 px-1  md:gap-4">
